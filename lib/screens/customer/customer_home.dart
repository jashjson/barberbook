...
class _CustomerHomeState extends State<CustomerHome> {
  ...
  final List<String> _filters = ['All', 'Open Now', 'Top Rated'];
  ...
  Future<void> _load() async {
    ...
    final barbers = await FirebaseService.getAllBarbers();
  ...
  List<BarberModel> get _filtered {
    var list = List<BarberModel>.from(_barbers);
    if (_filter == 'Open Now') {
  ...
  Future<void> _toggleFav(String id) async {
    ...
    await FirebaseService.toggleFavourite(id, !isFav);
  }
              ...
              child: Column(
                ...
                children: [
                  ...
                  Row(
                    ...
                    children: [
                      Text(
                        minPrice > 0 ? 'From ₹$minPrice' : 'View services',
                        style: const TextStyle(
                          fontSize: 13,
                          fontWeight: FontWeight.bold,
                          color: AppTheme.secondary,
