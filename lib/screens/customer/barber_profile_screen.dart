...
class _BarberProfileScreenState extends State<BarberProfileScreen> {
  ...
  Future<void> _toggleFav() async {
    ...
    await FirebaseService.toggleFavourite(widget.barber.id, newFav);
    if (mounted) {
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
          content: Text(
            newFav ? 'Added to favourites ♡' : 'Removed from favourites',
          ),
            ...
            child: Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    b.bio.isNotEmpty ? b.bio : 'No description yet.',
                    style: const TextStyle(
                      fontSize: 13,
                      color: AppTheme.textGrey,
                      height: 1.5,
                      ...
                      (r) => Container(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            const SizedBox(height: 8),
                            Text(
                              r.comment.isNotEmpty ? r.comment : '(No comment)',
                              style: const TextStyle(
                                fontSize: 13,
                                color: AppTheme.textGrey,
                                height: 1.4,
